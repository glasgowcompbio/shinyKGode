...
res = gradient_match_third_step(sbml_data$mi$nStates, length(sbml_data$params), kkk, y_no)
print(res$ode_par)
...
fixlens=c(3,3)
res = warping(sbml_data$mi$nStates, length(sbml_data$params), kkk, y_no, peod, eps, fixlens)
print(res$ode_par)
